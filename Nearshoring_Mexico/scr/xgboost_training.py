...
def xgboost_training(X_train_cv, y_train_cv, X_vault, y_vault, file_path):
    ...
    # Save the best XGBoost model to a file for future use
    best_xgb.save_model(f'{file_path}xgboost_model.json')
